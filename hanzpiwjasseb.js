...
`, {
        ...
        reply_markup: {
          inline_keyboard: [
            [{ text: "💎 Perpanjang Premium", url: `https://t.me/hanzxstr${DEVELOPER.replace('@hanzxstr', '')}` }],
            [{ text: "📢 Channel Info", url: `https://t.me/abouthanzpiw${CHANNEL_USERNAME.replace('@abouthanzpiw', '')}` }]
          ]
        }
      }).catch(() => {});
    }
...
`, {
      ...
      reply_markup: {
        inline_keyboard: [
          [{ text: "📢 Gabung Channel Resmi", url: `https://t.me/abouthanzpiw${CHANNEL_USERNAME.replace('@abouthanzpiw','')}` }],
...
<blockquote>✨ BotCreated By @hanzxstr</blockquote>
`;
...
• @hanzxstr / Developer
<blockquote>✨ Created By @hanzxstr</blockquote>
`;
    return replaceMenu(chatId, caption, {
