...
const fs = require("fs");
const bot = new Telegraf("8242182931:AAFY3bLNQ4tMm7eJ_bZrKu7Zauhj8cb9d6U");
...
/* 1.  ID channel */
const channelId = "@infohanzpiw"; // USERNAME CHANNEL 
    ...
    if (!ok) {
      return ctx.reply(
        ...
        Markup.inlineKeyboard([
          Markup.button.url("Join Channel", `https://t.me/infohanzpiw${channelId.replace("@infohanzpiw", "")}`)
        ])
      );
    }
  }
...
`,
    ...
    ...Markup.inlineKeyboard([
      ...
      [
        ...
        { text: '『 ᴄʜᴀɴɴᴇʟ ᴏᴡɴᴇʀ 』', url: 'https://t.me/infohanzpiw' },
      ],
      [
